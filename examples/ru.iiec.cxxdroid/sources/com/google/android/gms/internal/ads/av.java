...
public final class av {
    ...
    private av(ByteBuffer byteBuffer) {
        this.a = byteBuffer;
        this.a.order(ByteOrder.LITTLE_ENDIAN);
    }

    private av(byte[] bArr, int i2, int i3) {
    ...
    public static av a(byte[] bArr, int i2, int i3) {
        return new av(bArr, 0, i3);
    }
    ...
    public static int b(int i2, iv ivVar) {
        int b2 = b(i2);
        int a2 = ivVar.a();
        return b2 + d(a2) + a2;
    }
    ...
    private final void e(int i2) {
        ...
        throw new bv(this.a.position(), this.a.limit());
    }
    ...
    public final void a(int i2, String str) {
        ...
        try {
            int d2 = d(str.length());
            if (d2 == d(str.length() * 3)) {
                int position = this.a.position();
                if (this.a.remaining() >= d2) {
                    this.a.position(position + d2);
                    a(str, this.a);
                    int position2 = this.a.position();
                    this.a.position(position);
                    a((position2 - position) - d2);
                    this.a.position(position2);
                    return;
                }
                throw new bv(position + d2, this.a.limit());
            }
            a(a((CharSequence) str));
            a(str, this.a);
        } catch (BufferOverflowException e2) {
            bv bvVar = new bv(this.a.position(), this.a.limit());
            bvVar.initCause(e2);
            throw bvVar;
        }
    }
