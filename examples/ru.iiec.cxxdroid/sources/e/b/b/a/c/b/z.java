...
public final class z {
    ...
    private z(ByteBuffer byteBuffer) {
        this.a = byteBuffer;
        this.a.order(ByteOrder.LITTLE_ENDIAN);
    }

    private z(byte[] bArr, int i2, int i3) {
    ...
    public static int b(int i2, i0 i0Var) {
        int d2 = d(i2);
        int b2 = i0Var.b();
        return d2 + e(b2) + b2;
    }
    ...
    private final void c(int i2) {
        ...
        throw new b0(this.a.position(), this.a.limit());
    }
    ...
    public final void a(int i2, String str) {
        ...
        try {
            ...
            if (e2 == e(str.length() * 3)) {
                ...
                throw new b0(position + e2, this.a.limit());
            }
            a(a(str));
            a(str, this.a);
        } catch (BufferOverflowException e3) {
            b0 b0Var = new b0(this.a.position(), this.a.limit());
            b0Var.initCause(e3);
            throw b0Var;
        }
    }
