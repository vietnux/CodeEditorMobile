...
//        this.compilerZipPath = context.getApplicationInfo().nativeLibraryDir + "/compiler/gcc.zip";
//        this.compilerZipPath = Environment.getExternalStorageDirectory() + "/CodeEditorProjects/compiler/gcc.zip";
//        this.compilerZipPath = MainActivity.getContext().getExternalCacheDir() + "/compiler/gcc.zip";
