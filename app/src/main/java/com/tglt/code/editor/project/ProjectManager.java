package com.tglt.code.editor.project;
...
//    public void readPreviousProjects(@NonNull List<Project> projectList) throws JSONException, IOException {
    public void readPreviousProjects() throws JSONException, IOException {
        workspace = new File(Environment.getExternalStorageDirectory() + "/CodeEditorProjects/");
//        workspace = new File(MainActivity.getContext().getExternalCacheDir() + "/Gcc/");
//        workspace = new File(MainActivity.getContext().getFilesDir().getAbsolutePath() + "/Gcc/");
        if (!workspace.exists()) {
            workspace.mkdir();
        }
