        ...
        ThreadUtils.executeByCached(new ThreadUtils.SimpleTask<Object>() {
            ...
            public Object doInBackground() throws Throwable {
                ...
                if (!sourceFileOrDir.exists()) {
                    throw new Exception("The compiled code source does not exist!");
                }
                ...
                // 权限错误
                if (!existsDir) {
                    throw new Exception("Unable to create a folder to save compiled class files, please check permissions：" + saveFolder.getAbsolutePath());
                }
                // 删除已经存在的内容
                ...
                if (libFolder != null) {
                    if (!FileUtils.createOrExistsDir(libFolder)) {
                        throw new Exception("Unable to read the dependent storage folder, please check the permissions：" + libFolder.getAbsolutePath());
                    }
                ...
                Log.i("Compiled dependent classpath", classPath);
                ...
                Log.i("Compile command", Arrays.toString(compileCmd));
                    ...
                    // 当编译的是文件夹项目时
                        ...
                        try {
                            ...
                            if (b) {
                                ...
                                throw new Exception("Jar packaging error: permission error or unknown error");
                            }
                        } catch (Exception e) {
                            throw new Exception("Jar packaging error ", e);
                        }
                    }
                } else {
                    // 读取错误日志
                    String log = FileIOUtils.readFile2String(logFilePath);
                    throw new Exception("Bytecode compilation error：\n" + log);
                }
            }
